...
description: Validate that orchestrator plan files conform to expected JSON schema. Use before workers read plan files or after orchestrators create them to ensure proper structure and required fields. SKIP: для plan-файлов из других orchestrator систем (другая схема).
allowed-tools: Read
---
