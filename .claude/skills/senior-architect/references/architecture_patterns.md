...
export * from '@<project>/shared-types/database.types';

// <project-package-path>/src/types/database.ts (RE-EXPORT ONLY)
export type { Database } from '@<project>/shared-types';
```
...
```
packages/
├── <your-project>/  # Backend (Node.js, tRPC, BullMQ)
...
**Pattern:**
```
<project-package-path>/supabase/migrations/
