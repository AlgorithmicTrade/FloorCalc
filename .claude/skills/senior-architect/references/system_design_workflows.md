...
// 3. tRPC router
// <project-package-path>/src/server/routers/enrichments.ts
...
<project-package-path>/supabase/migrations/YYYYMMDD_add_enrichments.sql

# 3. Backend implementation
<project-package-path>/src/server/routers/enrichments.ts
<project-package-path>/src/stages/stage7-enrichments/
...
# Node.js profiling
node --inspect <project-package-path>/dist/server.js
...
```typescript
// <project-package-path>/src/server/routers/courses.ts
import { router, publicProcedure } from '../trpc';
import { CreateCourseSchema } from '@<project>/shared-types';
...
```typescript
// <project-package-path>/src/server/routers/_app.ts
...
```typescript
// <project-package-path>/tests/routers/courses.test.ts
...
pnpm --filter <your-project> add bullmq
...
// packages/web/package.json
{
  "dependencies": {
    ...
    "@<project>/trpc-client-sdk": "workspace:*"
  }
}
```
