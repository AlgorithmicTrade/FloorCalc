...
description: Extract version, dependencies, and metadata from package.json files. Use when needing project version, dependency list, or package metadata for releases, audits, or reports. SKIP: для multi-package-monorepo, где «версия проекта» неоднозначна; для не-npm проектов.
allowed-tools: Read
---
