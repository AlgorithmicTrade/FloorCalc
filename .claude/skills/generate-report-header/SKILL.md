...
description: Create standardized report headers with metadata for all agent-generated reports. Use when generating bug reports, security audits, dependency reports, or any worker output requiring consistent formatting. SKIP: для не-стандартных отчётов без YAML-frontmatter; для plain-text отчётов.
---
...
> **IMPORTANT**: All reports MUST be written in Russian language and saved to the `reports/` directory.
