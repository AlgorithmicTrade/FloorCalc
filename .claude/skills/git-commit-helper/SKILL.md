...
description: Generate descriptive commit messages by analyzing git diffs. Use when the user asks for help writing commit messages or reviewing staged changes. SKIP: для уже скоммиченных изменений (используй `git rebase` workflow); если в проекте есть commit_message.md rule — следовать ему.
---
