...
description: Generate standardized conventional commit messages with Claude Code attribution. Use when creating automated commits, release commits, or any git commit requiring consistent formatting. SKIP: для project-specific форматов (русскоязычные шаблоны); для merge/revert-коммитов; если в проекте есть commit_message.md rule с другим форматом — использовать его.
---
