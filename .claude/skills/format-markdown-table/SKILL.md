...
description: Generate well-formatted markdown tables from data with proper alignment and spacing. Use for report statistics, comparison tables, or summary data presentation. SKIP: для очень больших таблиц (>50 строк, >10 столбцов — лучше отдать как CSV).
---
