...
description: Parse and validate semantic version strings from various formats. Use for extracting versions from text, validating semver compliance, or comparing version numbers. SKIP: для парсинга non-semver форматов (CalVer, marketing-versions); для извлечения git-тегов без semver.
---
