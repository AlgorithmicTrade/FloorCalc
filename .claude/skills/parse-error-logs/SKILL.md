...
description: Parse build errors, test failures, type-check output, and validation logs into structured data. Use when processing npm/pnpm output, TypeScript errors, Jest failures, or any validation command results for quality gates. SKIP: для произвольных текстовых логов без структурированного формата (используй generic Read+Grep).
allowed-tools: Read
---
