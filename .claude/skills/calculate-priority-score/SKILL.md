...
description: Calculate priority score for bugs, issues, or tasks based on severity, impact, and likelihood. Use for bug prioritization, task ordering, or risk assessment. SKIP: для оценки кода/архитектуры (не bug/task scoring); для обычной приоритезации без severity/impact метрик.
---
