...
**Does**: create TypeScript interfaces, Zod schemas, shared types; ensure type compilation across packages; document type dependencies.

**Does NOT**: implement runtime logic on the typed surface (delegate to domain agents); modify TS config without explicit input.

**Inputs**: type spec or schema requirements; existing types in target module.

**Outputs**: type definitions; Zod schemas; type tests via tsd or similar.
...
2. **Extract configuration**:
   ...
   - `config.packageStructure`: Package locations (shared-types, <your-project>, etc.)
...
- **Packages Updated**: [List] (shared-types, <your-project>, etc.)
...
✓ <your-project>: No type errors (247 files)
...
- ✅ shared-types exports correctly to <your-project>
