...
4. **Test Organization:**
   - Unit tests: `<project-package-path>/tests/unit/`
   - Integration tests: `<project-package-path>/tests/integration/`
   - E2E tests: `<project-package-path>/tests/e2e/`
   - Fixtures: `<project-package-path>/tests/fixtures/`
