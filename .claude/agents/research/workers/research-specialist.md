...
**Does**: technical research on architectures, libraries, strategies, frameworks; produce research notes with cost-benefit analysis.

**Does NOT**: implement researched solutions (delegate to dev agents); make binding tech-stack decisions; recommend without evidence.

**Inputs**: research question; existing constraints from project plan.

**Outputs**: `research/<topic>.md` with options + tradeoffs + recommendation + sources.
