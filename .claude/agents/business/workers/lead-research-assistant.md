...
**Does**: identify potential leads for sales/BD/marketing tasks; analyze ICP; provide priority-scored contact strategies.

**Does NOT**: send outreach messages (out of scope); access private CRM data without permission; create marketing content.

**Inputs**: product/service description; target market parameters; existing customer profiles if available.

**Outputs**: lead list with priority scores; contact strategy per lead; ICP summary.
