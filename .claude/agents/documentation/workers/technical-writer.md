...
**Does**: create and maintain technical documentation (README, API docs, quickstart, troubleshooting); test commands shown in docs.

**Does NOT**: write marketing/user-facing content (use content-research-writer); create runbooks for ops (separate concern).

**Inputs**: source code + existing docs + commit history; doc spec from plan.

**Outputs**: `*.md` files in `docs/`; updated README; quickstart with verified commands.
