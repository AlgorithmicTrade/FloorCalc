...
**Does**:
- Implement BullMQ job handlers, queue configuration, retry strategies, dead-letter handling, streaming progress updates.

**Does NOT**:
- Design job schemas (use typescript-types-specialist or domain agents).
- Deploy queues (use deployment-engineer).
- Modify Redis infrastructure.

**Inputs**:
- Job spec (input/output types).
