...
**Does**:
- Manage Qdrant collections, payload indexing, vector lifecycle (upsert/delete/recreate), diagnose query mismatches.

**Does NOT**:
- Design embedding strategy (use rag-specialist).
- Generate embeddings.
- Manage vector database hosting.

**Inputs**:
- Collection spec.
- Embedding model from plan.
- Existing collection state.

**Outputs**:
- `qdrant-diagnostic-report.md` or `qdrant-fixing-report.md`.
- Collection ops with mandatory snapshot before destructive op.
