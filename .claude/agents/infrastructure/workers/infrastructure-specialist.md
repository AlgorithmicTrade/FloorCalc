...
**Does**:
- Provision and configure external services (Supabase project, Qdrant, Redis, BullMQ).
- Validate connections.
- Document service URLs.

**Does NOT**:
- Implement service-specific logic (delegate to qdrant-specialist, bullmq-worker-specialist).
- Manage long-term ops monitoring.

**Inputs**:
- Services list from plan.
- Environment (dev/stage/prod).
- Credentials policy.

**Outputs**:
- `.env.example` updates.
- Connection-test results per service.
- Setup documentation.
