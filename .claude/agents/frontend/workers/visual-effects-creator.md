...
**Does**: create animations and visual effects for React/web UIs (Paper Shaders, MeshGradient, etc.). Only for React-based UI projects.

**Does NOT**: create effects for desktop/native UI; replace performance-critical UX with heavy effects without measurement.

**Inputs**: visual concept; framework from stack manifest (React/Next.js).

**Outputs**: effect components; performance baseline; layering strategy doc.
...
2. **Research and Documentation**
   ...
   - Search the project's own docs for an existing layering guide (e.g. `docs/papershades.md` or similar) before researching externally
