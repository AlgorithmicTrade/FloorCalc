...
### Added
- **Web**: ввести ровную укладку economy, ErrorBoundary против чёрного экрана и bounds-guard swap-back (50d5a2f)
...
### Fixed
- **Web**: починить логику показа release-notes-модалки и автосоздание GitHub Releases в release.sh (3aa14cf)
...
- **CI**: починить тест releaseNotes.real — проверять секцию, а не любое слово «Изменения:» (866e1c7)
...
### Fixed
- **Web**: убрать тень у номера рулона, выровнять collapse-кнопку и обвести каталог (b08f5e3)
